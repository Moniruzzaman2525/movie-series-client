...
const ReusableCard = ({ movie }: { movie: MovieCardProps }) => {
     return (
          <div className="flex flex-col justify-between border bg-gray-50 dark:bg-black dark:border-white/20 border-black/10 w-full h-[500px] rounded-xl p-3 overflow-hidden shadow hover:shadow-lg transition-shadow">
