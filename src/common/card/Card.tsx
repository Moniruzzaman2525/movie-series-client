...
const ReusableCard = ({
  ...
  return (
    <CardContainer className="inter-var">
      <CardBody className="flex flex-col justify-between bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto  rounded-xl p-3  ">
        <div>
          <CardItem
            translateZ="50"
        ...
        <div className="flex justify-between items-center mt-6">
          ...
          >
            <Link href={`/movies/${id}`}>Watch Now →</Link>
          </CardItem>
