...
const SeriesCard = ({ series }: { series: any }) => {
     return (
          <div className="flex flex-col justify-between bg-gray-50 relative dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/20 border border-black/10 w-full h-full  rounded-xl p-3 overflow-hidden shadow hover:shadow-lg transition-shadow">
