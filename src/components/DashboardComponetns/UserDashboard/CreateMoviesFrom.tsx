...
const MovieForm = () => {
     ...
     const onSubmit:SubmitHandler<FieldValues> = async(data) => {
          ...
          const formValues = {
               ...
               streamingPlatform: data.streamingPlatform as string,
               description: data.description as string,
               // rating: Number(data.rating),
               ...(data.like && { like: Number(data.like) }),
                         ...
                         <div className="space-y-2">
                              ...
                              <div className="flex items-center space-x-4">
                                   <div className="relative w-32 h-32 rounded-lg overflow-hidden bg-gray-200">
                                        {previewImage ? (
                                             <Image height={500} width={500} src={previewImage} alt="Preview" className="w-full h-full object-cover" />
                                        ) : (
                              ...
                              {/* <div>
                                   ...
                                   <input
                                        ...
                                        {...register("rating", {
                                             ...
                                             max: {
                                                  value: 10,
                                                  message: "Rating can't be more than 10"
                                             }
                                        })}
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2 border"
                                   />
